...
export default function StatusBar() {
  ...
  return (
    <div
      className="absolute bottom-3 left-3 flex items-center gap-1.5 px-3 py-1.5 bg-card-glass backdrop-blur-sm rounded-none border border-border text-[0.78rem] text-foreground-secondary max-w-[calc(100%-24px)] z-10 status-bar-responsive"
      role="status"
    >
      <span
