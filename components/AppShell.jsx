...
export default function AppShell({ children }) {
  ...
  return (
    <main className="min-h-dvh h-dvh flex flex-col w-full overflow-hidden">
      ...
      <div className={`min-h-0 flex-1 grid items-stretch ${hasMapSidebar ? 'layout-sidebar grid-cols-[minmax(0,1fr)_560px]' : showMap ? 'grid-cols-1' : ''}`} style={showMap ? undefined : { display: 'contents' }}>
