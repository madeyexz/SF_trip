...
describe('map panel search overlay', () => {
  it('renders a submit-based places search form on the map', async () => {
    ...
    assert.match(source, /searchResultSelectionIds,/);
    ...
    assert.match(source, /handleToggleSearchResultSelection,/);
    assert.match(source, /handleSaveSelectedSearchResults,/);
  ...
  it('shows per-result save controls when places search results exist', async () => {
    ...
    assert.match(source, /handleToggleSearchResultSelection\(result\.id\)/);
    assert.match(source, /void handleSaveSelectedSearchResults\(\)/);
    assert.match(source, /handleOpenSearchResultTagEditor\(result\.id\)/);
    assert.match(source, /onMouseEnter=\{\(\) => handlePreviewSearchResult\(result\.id\)\}/);
    assert.match(source, /id=\{`search-result-\$\{result\.id\}`\}/);
    assert.match(source, /Save Spot/);
    assert.match(source, /Remove Spot/);
    assert.match(source, /Save Selected/);
